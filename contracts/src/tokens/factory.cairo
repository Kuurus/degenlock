...
#[starknet::interface]
trait Istarknet_forge_templateMemecoinFactory<TContractState> {
...
#[starknet::contract]
mod starknet_forge_templateMemecoinFactory {
    ...
    use super::Istarknet_forge_templateMemecoinFactory;
    ...
    #[external(v0)]
    impl starknet_forge_templateMemeCoinFactoryImpl of Istarknet_forge_templateMemecoinFactory<ContractState> {
