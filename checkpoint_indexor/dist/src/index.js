...
const checkpointOptions = {
    logLevel: checkpoint_1.LogLevel.Debug,
    prettifyLogs: true // uncomment in local dev
};
// Initialize checkpoint
const checkpoint = new checkpoint_1.default(config_json_1.default, writers, schema, checkpointOptions);
...
app.use(express_1.default.urlencoded({ limit: '4mb', extended: false }));
app.use((0, cors_1.default)({ maxAge: 86400 }));
